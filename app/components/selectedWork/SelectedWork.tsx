...
const projects: Project[] = [
  {
    ...
    content: {
      ...
      description2: "My role focuses on building a modern, high-performance UI with React, ensuring seamless integration with backend APIs, and crafting an intuitive experience for complex data interactions. I collaborate closely with cross-functional teams to build and maintain a scalable, responsive codebase.",
  ...
  },
  {
    ...
    content: {
      ...
      description2: "It was a fantastic chance for me to see a project through from start to finish and gain some valuable experience as a developer.",
      image: "/excella.png",
    },
  },
  {
    ...
    content: {
      ...
      website: "https://www.7secondsolar.com/",
      description1:
        "This is another project where I was the lead developer while working on contract for4Shaw Productions. ",
      description2: "It is an understated yet functional Cash Advance solution website that was built in Wordpress using Elementor and some custom CSS and Javascript.",
      image: "/7SecondSOlar.png",
    },
  },
  {
    ...
    content: {
      ...
      description2: "It is a simple frontend budgeting app that saves user data to Local Storage that allows you to create budgets and helps you track your expenses.",
      image: "/7SecondSOlar.png",
    },
  },
];
