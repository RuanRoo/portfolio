...
export default function Footer() {
  return (
    <div className="flex gap-4 justify-between border-t border-grey-400 m-10">
      ...
      <div className="flex">
        <div className="bg-brandblue rounded-2xl h-64 w-[825px] mt-32 text-grey-100 flex flex-col justify-between py-6 px-10">
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              <svg
                ...
                className="text-grey-100 group-hover:text-grey-400 transition-all duration-300 ease-in-out transform group-hover:scale-125"
              >
