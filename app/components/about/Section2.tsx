...
export default function Section2() {
  return (
    <div className="mt-36">
      <div className="font-semibold tracking-tighter text-5xl">When I'm not coding <br /> you will find me</div>
      <div className="flex justify-between gap-2 my-20 pr-16 pt-7">
        ...
        <div className="flex gap-6">
          <div >
            ...
            <div className="flex items-center w-80 gap-4 bg-[#ededf6] rounded-md mt-6 ml-auto p-4">
          ...
          <div>
            <div className="flex items-center w-80 gap-4 bg-[#ededf6] rounded-md mt-11 mb-6 p-4">
